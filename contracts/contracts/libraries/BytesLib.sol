...
// This library is required to parse the encoded path passed as input to a Uniswap swap. The @uniswap/v3-periphery package
// includes an older version of this contract that only supported solidity >=0.5.0 and <0.8.0, so we replace that
