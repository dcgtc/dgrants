...
const messagesToReplace = [
  ...
  // replace every other message with a human readable catchAll
  {
    ...
    replace: (errorMsg: string) => `
      ...
      <p>Please email <a href="mailto:support-grants@gtcdao.net">support-grants@gtcdao.net</a> with a description of your problem and the following error message:</p><br/>
