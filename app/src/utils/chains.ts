...
export const ALL_CHAIN_INFO: ChainInfo = {
  ...
  [SupportedChainId.POLYGON]: {
    ...
    grantRegistry: '0x953A53b3B9B571CE05f4e7e42DBaEa3817C0FCB6',
    grantRoundManager: '0x59cCFE411aB4480D3f74aFAe1a4e644A5Ce49Eb8',
    grantRoundManagerAbi: GRANT_ROUND_MANAGER_UNI_V2_ABI,
    multicall: '0xd3BB9902C9ae1ECbDB9cCAdbD009F827699185Cb',
    rpcUrl: 'https://polygon-rpc.com/',
    subgraphUrl: 'https://api.thegraph.com/subgraphs/name/dcgtc/dc-gitcoin-grants-matic-staging',
    startBlock: 21463653,
  ...
  [SupportedChainId.RINKEBY]: {
    ...
    nativeCurrency: { name: 'Ethereum', symbol: 'ETH', decimals: 18 },
    grantRegistry: '0x1FA4BDCD618BA694351CE26b483E8F8705Fa840A',
    grantRoundManager: '0x948b0C24BF58D43993484Da4ecfBE881216DB956',
    grantRoundManagerAbi: GRANT_ROUND_MANAGER_ABI_UNI_V3_ABI,
    multicall: '0x5BA1e12693Dc8F9c48aAD8770482f4739bEeD696',
